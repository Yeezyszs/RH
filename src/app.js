...
import { h, iniciais, fmtDate, fmtBRL, addDays, tempoCasa, diasAte, mesChave, mesLabel } from './utils/formatting.js?v=20260623g';
import { CHART_COLORS, STATUS_LABEL, VENC_CAT_BADGE, ADV_TIPO_BADGE, ADV_STATUS_BADGE, SETOR_ICON } from './constants.js?v=20260623g';

import { ColaboradoresModule }    from './modules/colaboradores.js?v=20260623g';
import { AdvertenciasModule }     from './modules/advertencias.js?v=20260623g';
import { FeriasModule }           from './modules/ferias.js?v=20260623g';
import { DesligamentosModule }    from './modules/desligamentos.js?v=20260623g';
import { CronogramaModule }       from './modules/cronograma.js?v=20260623g';
import { VencimentosModule }      from './modules/vencimentos.js?v=20260623g';
import { EpiModule }              from './modules/epi.js?v=20260623g';
import { RotatividadeModule }     from './modules/rotatividade.js?v=20260623g';
import { SalariosModule }         from './modules/salarios.js?v=20260623g';
import { ValeCombustivelModule }  from './modules/vale-combustivel.js?v=20260623g';
import { ValeAlimentacaoModule }  from './modules/vale-alimentacao.js?v=20260623g';
import { FeedbackClimaModule }    from './modules/feedback.js?v=20260623g';
import { PlanoCarreirasModule }   from './modules/plano-carreiras.js?v=20260623g';
